    ...
    <form className="form-card" onSubmit={handleSubmit}>
      ...
      {reservationLocked && (
        <p className="form-note">
          This space has a current or upcoming reservation. To correct a
          parking-space mistake, you may change only the slot number until the
          reservation ends.
        </p>
      )}
        ...
        <label>
          ...
          >
            ...
            {slotNumbers.map((slotNumber) => (
              <option key={slotNumber}>{slotNumber}</option>
            ))}
          </select>
        </label>
        <label>
          Location
          <input value="Level A" disabled />
        </label>
        <label>
          Vehicle Type
          <select
